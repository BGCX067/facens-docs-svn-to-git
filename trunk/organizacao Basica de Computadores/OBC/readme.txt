Altera Complete Design Suite Release 7.2 Service Pack 1 README.TXT
=================================================================

This readme.txt file accompanies the Quartus II Version 7.2
Service Pack 1 Update. After you have installed this update,
the Service Pack Installed field in the About Quartus II box 
(Help menu) will indicate "1".
...
in versions for UNIX & Linux and Windows workstations from the 
Literature page of the Altera website.
...
*  DSP Builder
*  MegaCore IP Library, which includes the following MegaCore 
   functions and their corresponding user guides
      2D FIR Filter                             v7.2 SP1  
      2D Median Filter                          v7.2 SP1 
      8B10B Encoder/Decoder                     v7.2 SP1 
      Alpha Blending Mixer                      v7.2 SP1 
      ASI                                       v7.2 SP1 
      CIC Compiler                              v7.2 SP1 
      Color Space Converter                     v7.2 SP1 
      CRC Compiler                              v7.2 SP1 
      Chroma Resampler                          v7.2 SP1 
      DDR & DDR2 SDRAM Controller               v7.2 SP1 
      DDR SDRAM High Performance Controller     v7.2 SP1 
      DDR2 SDRAM High Performance Controller    v7.2 SP1 
      Deinterlacer                              v7.2 SP1 
      FFT/IFFT                                  v7.2 SP1 
      FIR Compiler                              v7.2 SP1 
      Gamma Corrector                           v7.2 SP1 
      HyperTransport                            v7.2 SP1 
      Line Buffer Compiler                      v7.2 SP1 
      NCO Compiler                              v7.2 SP1 
      Nios II Embedded Processor                v7.2 SP1 
      PCI Compiler                              v7.2 SP1 
      PCI Express Compiler                      v7.2 SP1 
      POS-PHY Level 2 & 3 Compiler              v7.2 SP1 
      POS-PHY Level 4                           v7.2 SP1 
      QDRII SRAM Controller                     v7.2 SP1 
      RapidIO                                   v7.2 SP1 
      Reed-Solomon Compiler (Decoder & Encoder) v7.2 SP1 
      RLDRAM II Controller                      v7.2 SP1 
      HD/SD SDI                                 v7.2 SP1 
      Scaler                                    v7.2 SP1 
      SerialLite II                             v7.2 SP1 
      Triple Speed Ethernet                     v7.2 SP1 
      UTOPIA Level 2 Master                     v7.2 SP1 
      UTOPIA Level 2 Slave                      v7.2 SP1 
      Viterbi Compiler                          v7.2 SP1 
...
following operating systems and versions:
   ...
   Solaris 8 and Solaris 9 w/ 32-bit kernel
   Solaris 8 and Solaris 9 w/ 64-bit kernel
   Red Hat Enterprise Linux 3 for 32-bit or 
     for AMD64 or Intel EMT64 64-bit CPUs
...
the following operating systems and versions:
   ...
   Solaris 8 and Solaris 9 w/ 32-bit kernel
   Solaris 8 and Solaris 9 w/ 64-bit kernel
   Red Hat Enterprise Linux 3 for 32-bit  
     for AMD64 or Intel EMT64 64-bit CPUs
   Red Hat Linux 4.0 for 32-bit and for AMD64 
     or Intel EMT64 64-bit CPUs
   SUSE 9 Enterprise Linux
...
versions:
   ...
   MATLAB version 7.0 (R14) or later
   Simulink version 6.0 (R14) or later
...
FLEXlm
   ...
   that the version is 8.0 or later.
...
Display Manager
   ...
   Solaris
      dtwm -- The CDE (DeskTop) Window Manager
      vuewm -- A Window Manager from HP
      mwm -- OSF/Motif Window manager. 
      olwm -- Open Look Window Manager from Sun  
      olvwm, a derivative, is also supported.
                        
Hardware requirements/recommendations
-------------------------------------
   Pentium III or later for Windows or Linux 
   or
   Sun UltraSPARC-based Workstation for Solaris
...
7.2 SP1 requires approximately 5 GB of available disk space on the 
...
EP20K200/200C/200E)
Cyclone(TM) (EP1C3, EP1C4 and EP1C6)
Cyclone II (EP2C5)
...
Cyclone III (EP3C40)                      512 MB            512MB
...
Stratix III (EP3SE260)                    4.0 GB           6.0 GB

Stratix III (EP3SL340)                    4.0 GB           8.0 GB
